    ...
    F.fn.extend({
      ...
      mask: function (t, h) {
        ...
        return (
          ...
          (r = F.mask.definitions),
          (y = []),
          (g = j = t.length),
          (v = null),
          (t = String(t)),
          F.each(t.split(""), function (e, t) {
            "?" == t
              ? (j--, (g = e))
              : r[t]
              ? (y.push(new RegExp(r[t])),
                null === v && (v = y.length - 1),
                e < g && (b = y.length - 1))
              : y.push(null);
          }),
          this.trigger("unmask").each(function () {
            ...
            function l(e) {
              return e < h.placeholder.length
                ? h.placeholder.charAt(e)
                : h.placeholder.charAt(0);
            }
            function c(e) {
              for (; ++e < j && !y[e]; );
              return e;
            ...
            function w(e) {
              ...
              return (
                e
                  ? f()
                  : o + 1 < g
                  ? h.autoclear || s.join("") === d
                    ? (n.val() && n.val(""), p(0, j))
                    : f()
                  : (f(), n.val(n.val().substring(0, o + 1))),
                g ? a : v
              );
            }
            n.data(F.mask.dataName, function () {
              ...
              n
                ...
                .on("focus.mask", function () {
                  ...
                  n.prop("readonly") ||
                    ...
                    (o = setTimeout(function () {
                      n.get(0) === document.activeElement &&
                        (f(),
                        e == t.replace("?", "").length
                          ? n.caret(0, e)
                          : setTimeout(function () {
                ...
                .on("keydown.mask", function (e) {
                  ...
                  n.prop("readonly") ||
                    ...
                    8 === t || 46 === t || (k && 127 === t)
                      ...
                      ? m.call(this, e)
                      : 27 === t &&
                        (n.val(a), n.caret(0, w()), e.preventDefault()));
                })
                  ...
                  n.prop("readonly") ||
                    ...
                    e.ctrlKey ||
                      ...
                      (a &&
                        13 !== a &&
                        (t.end - t.begin != 0 &&
                          (p(t.begin, t.end), u(t.begin, t.end - 1)),
                        (r = c(t.begin - 1)) < j &&
                ...
                .on("input.mask paste.mask", function () {
                  var e;
                  n.prop("readonly") ||
                    (0 === n.attr("data-tilda-mask").indexOf("+7") &&
                      (0 === (e = n.val().replace(/\D/g, "")).indexOf("78") &&
                        n.val(e.substring(2)),
                      (0 !== e.indexOf("8") && 0 !== e.indexOf("7")) ||
                        n.val(e.substring(1))),
                    setTimeout(function () {
                      var e = w(!0);
                      n.caret(e), i();
              ...
              x &&
                _ &&
                n.off("input.mask").on("input.mask", function (e) {
                  function t() {
      ...
      (window.tildaForm = {
        ...
        arMessages: {
          ...
          UK: {
            ...
            successorder:
              "Дякую! Замовлення оформлене. Будь ласка зачекайте. Йде перехід до оплати...",
          },
          PL: {
            success: "Dziękuję! Dane wysłane pomyślnie.",
            successorder:
              "Dziękuję! Twoje zamówienie potwierdzono. Proszę czekać. Przechodzimy do płatności...",
          },
        },
        arValidateErrors: {
          EN: {
          ...
          UK: {
            ...
            string:
              "Ви написали некоректні символи. Дозволені лише літери, числа і знаки пунктуації",
            ...
            chosevalue:
              "Будь ласка, виберіть адресу із запропонованих варіантів",
            deliveryreq:
              "Неможливо оформити замовлення без доставки. Будь ласка, перезавантажте сторінку і спробуйте ще раз.",
          },
          PL: {
            ...
            nameeng: "Wpisz imię",
            string:
              "Wpisane niepoprawne symbole, akceptowane litery, cyfry i znaki interpunkcyjne",
            ...
            deliveryreq:
              "Nie można złożyć zamówienia bez wysyłki. Przeładuj stronę i spróbuj ponownie",
          },
        },
      }),
        ...
        (window.tildaForm.captchaCallback = function (e) {
          ...
          (window.tildaForm.validate = function (l) {
            ...
            var e,
              ...
              u = !0;
            return (
              l.find(".js-tilda-rule").each(function () {
                var e,
                  t,
                  r = $(this).data("tilda-req") || 0,
                  ...
                  switch (o) {
                    ...
                    case "url":
                      (e =
                        ...
                        0 < s.length &&
                          ((t = (t =
                            (t = s.split("//")) && 1 < t.length
                              ? t[1]
                              : t[0]).split("/")) &&
                          0 < t.length &&
                          "" < t[0]
                            ? (t = t[0]).match(e) || n.type.push("url")
                            : ((t && "" != t[0]) || n.type.push("url"),
                              (t = "")));
                      break;
                    case "phone":
                      (e = /^[0-9\(\)\-\+]+$/gi),
                        ((0 < d.length && !d.match(e)) ||
                          1 == (t = d.replace(/[^0-9]+/g, "")).indexOf("000") ||
                          1 == t.indexOf("111") ||
                          (1 == t.indexOf("222") && "5" != t.substring(0, 1)) ||
                          1 == t.indexOf("333") ||
                          1 == t.indexOf("444") ||
                          (1 == t.indexOf("555") && "0" != t.substring(0, 1)) ||
                          (1 == t.indexOf("666") && "0" != t.substring(0, 1)) ||
                          (1 == t.indexOf("8888") &&
                            "4" != t.substring(0, 1))) &&
                          n.type.push("phone");
                      break;
                    ...
                    case "string":
                      ...
                      break;
                    case "chosevalue":
                      "true" === $(this).attr("data-option-selected") ||
                        n.type.push("chosevalue");
                      break;
                    case "promocode":
                      !(
                        "y" === l.attr("data-formcart") &&
                        0 < d.length &&
                        window.tcart
                      ) ||
                        (window.tcart.promocode &&
                          window.tcart.prodamount_discountsum) ||
                        n.type.push("promocode");
                      break;
                    case "deliveryreq":
              ...
              "y" === l.attr("data-formcart") &&
                ((e =
                  ...
                  0 < window.tcart_minorder),
                (t =
                  void 0 !== window.tcart_mincntorder &&
                  0 < window.tcart_mincntorder),
                e &&
              ...
              if (t[l] && t[l].obj) {
                ...
                for (
                  (o = 0) <
                    (r = t[l].obj
                      .closest(i)
                      .addClass("js-error-control-box")).find(".t-input-error")
                      .length && (o = 1),
                    j = 0;
                  j < t[l].type.length;
                  j++
                      ...
                      ("" == n &&
                        ("" < t_form_dict(error + "field")
                          ...
                          : "" < t_form_dict(error) &&
                            (n = t_form_dict(error))),
                      "" < n &&
                        (r.find(".t-input-error").html(n),
                        r.find(".t-input-error").fadeIn()));
              }
            return (
              "" < s &&
              ...
              (window.errorTimerID = window.setTimeout(function () {
                $("#tilda-popup-for-error").fadeOut(),
                  e.find(".t-input-error").html("").fadeOut(),
          ...
          (window.tildaForm.showErrors = function (e, t) {
            ...
            for (
              ...
              if (t[s] && t[s].obj) {
                if (0 == s && "none" == t[s].obj) {
                  (a = e.find(".js-rule-error-all")).html(
                    t_form_dict("emptyfill")
                  ),
                ...
                for (
                  ...
                  (error = t[s].type[j]),
                    (n = ""),
                    (a = e.find(".js-rule-error-" + error)).attr(
                      "data-rule-filled"
                    )
                      ? a.css("display", "block").show()
                      : 0 < a.length
            ...
            return (
              e.find(".js-errorbox-all").css("display", "block").show(),
              e.trigger("tildaform:aftererror"),
              !0
            );
          }),
          ...
          (window.tildaForm.addMebersInfoToForm = function (e) {
            try {
              ...
              return (
                console.log("addMebersInfoToForm exception:"),
                console.log(e),
                !1
              );
            }
          ...
          (window.tildaForm.addPaymentInfoToForm = function (e) {
            ...
            var i =
              $("#allrecords").data("tilda-currency") ||
              $(".t706").data("project-currency-code") ||
              "";
            if (
              (i
                ...
                : window.tcart.currency &&
                  ...
                  (window.tildaForm.tildapayment.currency =
                    window.tcart.currency)),
              !window.tcart.delivery &&
                $(".t-radio_delivery:checked").length &&
                0 < $(".t-radio_delivery:checked").data("delivery-price"))
            )
              try {
                return (
            ...
            for (
              window.tcart.products &&
                ...
                (l = window.tcart.products.length),
                window.tildaForm.tildapayment.products = [],
                r = 0;
              r < l;
              r += 1
            ) {
              for (o in ((t = window.tcart.products[r]),
              (s = {}),
              (d = ""),
              ...
              t))
                if ("function" != typeof t[o])
                  if ("options" == o)
                    for (var c in ((window.tildaForm.tildapayment.products[r][
                      o
                    ] = {}),
                    t[o]))
                      void 0 ===
                        window.tildaForm.tildapayment.products[r][o][c] &&
                        (window.tildaForm.tildapayment.products[r][o][c] = {}),
                        t[o][c].option &&
                          (window.tildaForm.tildapayment.products[r][o][
                            c
                          ].option = t[o][c].option),
                        t[o][c].price &&
                          0 < t[o][c].price &&
                        ...
                        t[o][c].variant &&
                          (window.tildaForm.tildapayment.products[r][o][
                            c
                          ].variant = t[o][c].variant),
                        t[o][c].option &&
                          t[o][c].variant &&
                          ("" < d && (d += ", "),
                          (d = d + t[o][c].option + ":" + t[o][c].variant));
                  else window.tildaForm.tildapayment.products[r][o] = t[o];
              t.sku ? (s.id = t.sku) : t.uid && (s.id = t.uid),
                (s.name = t.name),
                t.price
                  ? ((s.price = t.price),
                    (s.quantity = parseInt(t.amount / t.price)))
                  : t.quantity && 1 < t.quantity
                  ? ((s.price = t.amount / t.quantity),
            ...
            window.tcart.delivery &&
              ...
              window.tcart.delivery &&
                0 <= window.tcart.delivery.price &&
                ((pricedelivery = window.tcart.delivery.price),
                (window.tildaForm.tildapayment.delivery.price =
                  window.tcart.delivery.price),
                0 < window.tcart.prodamount &&
                  void 0 !== window.tcart.delivery.freedl &&
                  0 < window.tcart.delivery.freedl &&
                  ((window.tildaForm.tildapayment.delivery.freedl =
                    window.tcart.delivery.freedl),
                  window.tcart.prodamount - a >= window.tcart.delivery.freedl &&
                    (pricedelivery = 0)),
                (s = {
                  name: window.tcart.delivery.name,
                  price: pricedelivery,
            ...
            try {
              [
                ...
                window.tcart.delivery &&
                  window.tcart.delivery[e] &&
                  (window.tildaForm.tildapayment.delivery[e] =
                    window.tcart.delivery[e]);
              });
            } catch (e) {
              console.log(e);
            ...
            if ("y" != $jform.data("formpaymentoff")) {
              if (
                (0 < $jform.find(".js-successbox").length &&
                  ...
                  t_form_dict("successorder") &&
                    $jform
                      .find(".js-successbox")
                      .html(t_form_dict("successorder")),
              ...
              if ("form" == arNext.type) {
                ...
                var key = "",
                  val = "",
                  html =
                    '<form id="js-tilda-payment-formid" action="' +
                    arNext.value.action +
                    '" method="post"  style="position:absolue;opacity:0;width: 1px; height: 1px; left: -5000px;">';
          ...
          (window.tildaForm.paysystemScriptLoad = function (e, t) {
            if (!t || !e || "http" != e.substring(0, 4))
              return console.log("Wrong script parameters."), !1;
            var r;
            window.scriptSysPayment || (window.scriptSysPayment = {}),
              (window.scriptSysPayment[t] &&
                !0 === window.scriptSysPayment[t]) ||
          ...
          (window.tildaForm.paysystemRun = function (
            ...
            if (
              (window.scriptSysPayment || (window.scriptSysPayment = {}),
              !window.scriptSysPayment[sysname] ||
                !0 !== window.scriptSysPayment[sysname])
            )
              return (
                window.tildaForm.paysystemScriptLoad(script, sysname),
                window.setTimeout(function () {
                  window.tildaForm.paysystemRun(
                    script,
                    sysname,
                    $jform,
                    functioncode,
          ...
          (window.tildaForm.paysystemSuccess = function (e, t) {
            ...
            window.Tilda &&
              ...
              ($("#allrecords").data("tilda-currency") ||
                $(".t706").data("project-currency-code") ||
                $("#allrecords").data("tilda-currency", t.currency),
            ...
            window.tildaForm.successEnd(e, t.successurl, a),
          ...
          (window.tildaForm.stripePay = function (i, n) {
            ...
            if (!window.stripehandler) {
              ...
              n.zipCode && 1 == n.zipCode && (r.zipCode = !0),
                n.billingAddress &&
                  1 == n.billingAddress &&
                  (r.billingAddress = !0),
                n.shipping && 1 == n.shipping && (r.shippingAddress = !0),
                (window.stripehandler = window.StripeCheckout.configure(r)),
                  ...
                  $.ajax({
                    ...
                    success: function (e) {
                      ...
                      window.Tilda &&
                        ...
                        ($("#allrecords").data("tilda-currency") ||
                          $(".t706").data("project-currency-code") ||
                          $("#allrecords").data("tilda-currency", n.currency),
                        Tilda.sendEventToStatistics(t, r, a, o)),
                        "" < n.successurl &&
                          window.setTimeout(function () {
                            window.location.href = n.successurl;
                          }, 300),
                        "" < i.data("successmessage")
                          ? i
                              .find(".js-successbox")
                              .html(i.data("successmessage"))
                          : i.find(".js-successbox").html(""),
                        i.data("successmessage", "");
                      o = i.data("success-callback");
                      window.tildaForm.successEnd(i, n.successurl, o),
                        i.trigger("tildaform:aftersuccess");
                    },
                    fail: function () {},
                    timeout: 15e3,
                  });
          ...
          (window.tildaForm.cloudpaymentPay = function (i, n) {
            ...
            if (!window.cloudpaymentshandler) {
              ...
              (e = { language: t }),
                n.applePaySupport &&
                  "off" == n.applePaySupport &&
                  (e.applePaySupport = !1),
                n.googlePaySupport &&
                  "off" == n.googlePaySupport &&
                  (e.googlePaySupport = !1),
                (window.cloudpaymentshandler = new cp.CloudPayments(e));
            }
            e = {};
            (e.projectid = n.projectid),
              n.cloudPayments &&
                (n.cloudPayments.recurrent ||
                  n.cloudPayments.customerReceipt) &&
                (e.cloudPayments = n.cloudPayments);
            var d = i.closest(".t-popup_show");
            return (
              (d && 0 != d.length) || (d = i.closest(".t706__cartwin_showed")),
              d.data("old-style", d.attr("style")),
              d.attr("style", "z-index:100"),
              (window.tildaForm.orderIdForStat = n.invoiceId),
              n.skin || (n.skin = "classic"),
              window.cloudpaymentshandler.charge(
                ...
                function (e) {
                  (window.cloudpaymentshandler = !1),
                    d.attr("style", d.data("old-style"));
                  var t = "/tilda/" + i.attr("id") + "/payment/",
                    r = "Pay order in form " + i.attr("id"),
                    o = n.amount,
                    a = n.description;
                  $("#allrecords").data("tilda-currency", s),
                    window.Tilda &&
                      "function" == typeof Tilda.sendEventToStatistics &&
                      Tilda.sendEventToStatistics(t, r, a, o),
                    window.tildaForm.clearTCart(i),
                    ...
                    "" < i.data("successmessage")
                      ? i.find(".js-successbox").html(i.data("successmessage"))
                      : i.find(".js-successbox").html(""),
                    i.data("successmessage", "");
                  o = i.data("success-callback");
                  window.tildaForm.successEnd(i, n.successurl, o),
                ...
                function (e, t) {
                  if (
                    ...
                    window.location.href = n.failureurl;
                  else {
                    d.find(".t706__cartwin-products").show(),
                      d.find(".t706__cartwin-prodamount-wrap").show(),
                      d.find(".t706__form-bottom-text").show(),
                      i.find(".t-form__inputsbox").show();
                    try {
                      tcart__lockScroll();
                    } catch (e) {}
                  }
          ...
          (window.tildaForm.sendStatAndShowMessage = function (
            $jform,
            arArgs,
            sendStat
          ) {
            ...
            sendStat &&
              ...
              0 < $jform.find(".js-successbox").length &&
                ...
                arArgs.successmessage && "" < arArgs.successmessage
                  ...
                  ? $jform
                      .find(".js-successbox")
                      .html($jform.data("successmessage"))
                  : t_form_dict("success")
            ...
            ((successcallback &&
              0 < successcallback.length &&
              "t396_onSuccess" === successcallback &&
              "function" == typeof window.t396_onSuccess) ||
              (successcallback &&
                0 < successcallback.length &&
                "t396_onSuccess" !== successcallback)) &&
          ...
          (window.tildaForm.banktransferPay = function (t, r) {
            var o, a;
            (!r || "fast" != r.condition) && r && "" < r.html
              ? ($("#allrecords").append(r.html),
                  ...
                  try {
                    "function" == typeof tcart__closeCart &&
                      ...
                      setTimeout(function () {
                        ...
                        (e && 0 != e.length) ||
                          (e = t.closest(".t706__cartwin_showed")),
                          e.find(".t706__cartwin-products").show(),
                          e.find(".t706__cartwin-prodamount-wrap").show(),
                          e.find(".t706__form-bottom-text").show(),
                ...
                0 < (o = $("#formbanktransfer")).length &&
                  (o.off("submit"),
                  o.find(".t-submit").off("click"),
                  o.find(".t-submit").off("dblclick"),
                  o.submit(function (e) {
                    return (
                      e.preventDefault(),
                      (a = window.tildaForm.validate(o)) && 0 < a.length
                        ? (window.tildaForm.showErrors(o, a), !1)
                        : void $.ajax({
                            type: "POST",
                            url:
                              "https://" +
                            ...
                            success: function (e) {
                              if (
                                ($("body").removeClass("t-body_popupshowed"),
                                o.closest(".t-banktransfer").remove(),
                                (e = e || {
                                  error:
                                    "Unknown error. Please reload page and try again later.",
                                }) && e.error)
                              )
                                return alert(e.error), !1;
          ...
          (window.tildaForm.send = function (
            ...
            (window.tildaForm.tildapayment = !1),
              ("y" == $jform.data("formcart") ||
                0 < $jform.closest(".t706__orderform").length) &&
            ...
            if (2 == formtype || (!formtype && "" < formskey)) {
              ...
              ($inputElem && 0 != $inputElem.length) ||
                ($jform.append(
                  '<input type="hidden" name="tildaspec-cookie" value="">'
                ),
                ($inputElem = $jform.find("input[name=tildaspec-cookie]"))),
                ...
                ($inputElem && 0 != $inputElem.length) ||
                  ($jform.append(
                    '<input type="hidden" name="tildaspec-referer" value="">'
                  ),
                  ($inputElem = $jform.find("input[name=tildaspec-referer]"))),
                ...
                ($inputElem && 0 != $inputElem.length) ||
                  ($jform.append(
                    '<input type="hidden" name="tildaspec-formid" value="">'
                  ),
                  ($inputElem = $jform.find("input[name=tildaspec-formid]"))),
                ...
                "" < formskey &&
                  ...
                  ($inputElem && 0 != $inputElem.length) ||
                    ($jform.append(
                      '<input type="hidden" name="tildaspec-formskey" value="">'
                    ),
                    ($inputElem = $jform.find(
                      "input[name=tildaspec-formskey]"
                    ))),
                  0 < $inputElem.length && $inputElem.val(formskey)),
                ($inputElem = $jform.find("input[name=tildaspec-version-lib]")),
                ($inputElem && 0 != $inputElem.length) ||
                  ($jform.append(
                    '<input type="hidden" name="tildaspec-version-lib" value="">'
                  ),
                  ($inputElem = $jform.find(
                    "input[name=tildaspec-version-lib]"
                  ))),
                0 < $inputElem.length &&
                ...
                ($inputElem && 0 != $inputElem.length) ||
                  ($jform.append(
                    '<input type="hidden" name="tildaspec-pageid" value="">'
                  ),
                  ($inputElem = $jform.find("input[name=tildaspec-pageid]"))),
                0 < $inputElem.length &&
                ...
                ($inputElem && 0 != $inputElem.length) ||
                  ...
                  ($inputElem = $jform.find(
                    "input[name=tildaspec-projectid]"
                  ))),
                0 < $inputElem.length &&
                ...
                ($inputElem && 0 != $inputElem.length) ||
                  ($jform.append(
                    '<input type="hidden" name="tildaspec-lang" value="">'
                  ),
                  ($inputElem = $jform.find("input[name=tildaspec-lang]"))),
              ...
              $jform.find(".js-form-spec-comments").val(""),
                ($formurl =
                  "https://" + window.tildaForm.endpoint + "/procces/");
              var d = {};
              if (
              ...
              return (
                $jform.trigger("tildaform:beforesend"),
                $.ajax({
                  type: "POST",
                  url: $formurl,
                  data: d,
                    ...
                    if (
                      ...
                      (virtPage && "" != virtPage) ||
                        (virtPage =
                          ...
                          ((json.next &&
                            json.next.type &&
                            ("function" != json.next.type ||
                              (json.next.value &&
                                ("stripev3" == json.next.value.sysname ||
                                  "outersite" ==
                                    json.next.value.installation)))) ||
                            !json.next)
                            ? "/tilda/" + $jform.attr("id") + "/payment/"
                            : "/tilda/" + $jform.attr("id") + "/submitted/");
                      var virtTitle =
                          "Send data from form " + $jform.attr("id"),
                        virtPrice = 0,
                        virtProduct = "";
                      if (
                        window.Tilda &&
                        ...
                        window.tildaForm.tildapayment.amount
                          ...
                          : 0 < $jform.find(".js-tilda-price").length &&
                            ((virtPrice = $jform.find(".js-tilda-price").val()),
                            0 < parseFloat(virtPrice) &&
                              (virtTitle = "Order " + formres.orderid));
                        try {
                          Tilda.sendEventToStatistics(
                            virtPage,
              ...
              return (
                ...
                $.ajax({
                  ...
                  success: function (e) {
                    ...
                    if (
                      ...
                      if ("{" == e.substring(0, 1)) {
                        if (
                          ...
                          "OK" != t.message &&
                            $jform.find(".js-successbox").html(t.message);
                        else if (t && t.error) {
                          ...
                          return (
                            (i && 0 != i.length) ||
                              (a.append(
                                '<p class="js-rule-error-all">Unknown error. Please, try again later.</p>'
                              ),
                    ...
                    window.Tilda &&
                    "function" == typeof Tilda.sendEventToStatistics
                      ? window.Tilda.sendEventToStatistics(a, e, "", 0)
                      : ("undefined" != typeof ga &&
                          "tilda" != window.mainTracker &&
                          ga("send", {
                            hitType: "pageview",
                      ...
                      $jform.trigger("tildaform:aftersuccess"),
                      window.tildaForm.successEnd($jform, r, o);
                  },
                  error: function (e) {
                    btnformsubmit.removeClass("t-btn_sending"),
                      btnformsubmit.data("form-sending-status", "0"),
            ...
            return (
              -1 == attraction.indexOf(window.tildaForm.endpoint) &&
              (btnformsubmit.removeClass("t-btn_sending"),
          ...
          $(".r").on("blur", ".js-tilda-rule", function () {
            ...
            "" < e &&
              ($(this).attr("placeholder", e), $(this).data("placeholder", ""));
          }),
        ...
        0 < $jallforms.length &&
          ...
          $(".r").on("submit", ".js-form-proccess", function (e) {
            ...
            return r && 3 == r
              ...
              : ($(this)
                  .find("[type=submit]")
                  .hasClass("t706__submit_disable") ||
                  $(this).find("[type=submit]").trigger("click"),
                !1);
          }),
          $(".r").on(
            "dblclick",
            ".js-form-proccess [type=submit]",
            function (e) {
          ...
          $(".r").on("click", ".js-form-proccess [type=submit]", function (e) {
            ...
            if (
              0 == r.find(".js-formaction-services").length &&
              1 != e &&
              "" == o
            ) {
              ...
              return (
                (i && 0 != i.length) ||
                  ...
                  (i = a.find(".js-rule-error-all"))),
                i.html("Please set receiver in block with forms").show(),
                a.show(),
